...
import de.bwaldvogel.liblinear.Train1;
 ...
 */
public class ClassificationEval_1 {
    ...
    public ClassificationEval_1(String inPathGoldenLabelsFile,
            ...
            throws Exception
    {
        ...
        for (File file : files) {
            ...
            ClassificationEval_1 dce = new ClassificationEval_1(pathGoldenLabelsFile,
            ...
            double value = new Train1().run(param); // dce.computeCoherence();
    ...
    public static void main(String[] args)
            throws Exception
    {
        ClassificationEval_1.evaluate("/home/cec/STTM/src/dataset/f.txt", "/home/cec/STTM/results", "theta");
    }
}
