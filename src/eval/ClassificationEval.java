...
public class ClassificationEval {
            ...
            throws Exception
    {
        ...
        System.out.println("pathDocTopicProsFile  is "+pathDocTopicProsFile );
        pathGoldenLabelsFile = inPathGoldenLabelsFile;
        System.out.println("pathGoldenLabelsFile is "+pathGoldenLabelsFile);
            ...
            throws Exception
    {
        ...
        try {
            int ind = -1;
             System.out.println("reading golden path"+pathGoldenLabelsFile);
            ...
            throws Exception
    {
        ...
        try {
            ...
            for (String docTopicProbs; (docTopicProbs = br.readLine()) != null;) {
               ...
               // System.out.print("Label for"+docIndex);
               // System.out.println("is"+oneText);
                docIndex++;
            }
        }
        catch (Exception e) {
    ...
    public void writeNewDocTopicPros()
            throws IOException
    {
        String folderPath = "/home/cec/STTM/result/";
        File dir = new File(folderPath);
        if (!dir.exists())
            dir.mkdir();
System.out.println("golden labels");
        ...
        for (int i = 0; i < docTopicProb.size(); i++) {
           // System.out.println(goldenLabel.get(i)+" ");
            ...
            //writer.write(goldenLabel.get(i) + " ");
            ...
            throws Exception
    {
        ...
        String thetafile=pathToFolderOfDocTopicProsFiles+"/tweet.theta";
        for (File file : files) {
    ...
    public static void main(String[] args)
            throws Exception
    {
        ClassificationEval.evaluate("/home/cec/STTM/src/dataset/b1.txt", "/home/cec/STTM/result", "theta");
    }
}
