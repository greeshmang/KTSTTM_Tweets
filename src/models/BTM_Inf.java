...
public class BTM_Inf
{
	...
	public String expName = "BTMinf";
	public String orgExpName = "BTMinf";
	public String tAssignsFilePath = "";
	public int savestep = 0;

	public BTM_Inf(String pathToTrainingParasFile,
	...
	public static void main(String args[])
		throws Exception
	{
		BTM_Inf btm = new BTM_Inf(
			"test/testBTM.paras", "test/unseenTest.txt", 100, 20, "testBTMinf",
			0);
		btm.inference();
	}
}
