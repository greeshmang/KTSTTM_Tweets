...
public class LDA_Inf1
{
	...
	public LDA_Inf1(String pathToTrainingParasFile,
			...
			for (String line; (line = br.readLine()) != null;) {
				...
				for (int j = 0; j < strTopics.length; j++) {
					int wordId = trainCorpus.get(docId).get(j);
                                        System.out.println("word in topic assignment"+id2WordVocabulary.get(wordId));
	...
	public void writeParameters()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.paras"));
	...
	public void writeDictionary()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.vocabulary"));
	...
	public void writeIDbasedCorpus()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.IDcorpus"));
		for (int dIndex = 0; dIndex < numDocuments; dIndex++) {
			int docSize = corpus.get(dIndex).size();
			for (int wIndex = 0; wIndex < docSize; wIndex++) {
	...
	public void writeTopicAssignments()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.topicAssignments"));
		for (int dIndex = 0; dIndex < numDocuments; dIndex++) {
			int docSize = corpus.get(dIndex).size();
			for (int wIndex = 0; wIndex < docSize; wIndex++) {
	...
	public void writeTopTopicalWords()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.topWords"));
	...
	public void writeTopicWordPros()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.phi"));
		for (int i = 0; i < numTopics; i++) {
	...
	public void writeTopicWordCount()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.WTcount"));
		for (int i = 0; i < numTopics; i++) {
			for (int j = 0; j < vocabularySize; j++) {
	...
	public void writeDocTopicPros()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.theta"));
		for (int i = 0; i < numDocuments; i++) {
	...
	public void writeDocTopicCount()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.DTcount"));
		for (int i = 0; i < numDocuments; i++) {
			for (int j = 0; j < numTopics; j++) {
		...
		throws IOException
	{
        ...
        public void updatecorpus() throws IOException
        {/*
            BufferedWriter writer = new BufferedWriter(new FileWriter("LDAinf.theta"));
		for (int i = 0; i < numDocuments; i++) {
			for (int j = 0; j < numTopics; j++) {
		...
		throws Exception
	{
		LDA_Inf lda = new LDA_Inf(
			"/home/cec/STTM/results/corpusLDA.paras", "/home/cec/STTM/src/dataset/tweettest.txt", 100, 20, "LDAinf",
			0);
		lda.inference();
	}
}
