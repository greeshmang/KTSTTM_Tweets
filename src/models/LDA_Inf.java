...
public class LDA_Inf
{
	...
	public List<List<Integer>> corpus; // Word ID-based corpus
       	public List<List<Integer>> corpusnew; // Word ID-based corpus
	...
	public HashMap<Integer, String> id2WordVocabulary; // Vocabulary to get word
        public HashMap<String, Integer> word2IdVocabularyE; // Vocabulary to get ID of external corpus
														// given a word
	public HashMap<Integer, String> id2WordVocabularyE; // Vocabulary to get word of external corpus
														// given an ID
	...
	public String expName = "corpusLDA";
	public String orgExpName = "corpusLDA";
	public String tAssignsFilePath = "";
	public int savestep = 0;
        public int[] dtopictheta;
		...
		throws Exception
	{
		...
		try {
			...
			for (String doc; (doc = br.readLine()) != null;) {
				...
				List<Integer> document = new ArrayList<Integer>();
                                List<Integer> documentnew = new ArrayList<Integer>();
				...
				for (String word : words) {
					if (word2IdVocabulary.containsKey(word)) {
						...
						// Skip this unknown-word
                                                //documentnew.add(word2IdVocabulary.get(word));
		...
		multiPros = new double[numTopics];
                dtopictheta=new int [numDocuments];
		...
		String pathToTopicAssignmentFile)
	{
		...
		sumTopicWordCount = new int[numTopics];
               ...
               /*
                System.out.println("Loading External corpus...");
		List<List<Integer>> trainCorpusE = new ArrayList<List<Integer>>();
		...
		try {
			...
			for (String doc; (doc = br.readLine()) != null;) {
				...
				trainCorpusE.add(documentE);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
		}
                //topicWordCounte = new int[numTopics][vocabularySizee];
		//sumTopicWordCounte = new int[numTopics];
                */

		try { System.out.println("readng topic assignment file"+pathToTopicAssignmentFile);
			...
			for (String line; (line = br.readLine()) != null;) {
				...
				for (int j = 0; j < strTopics.length; j++) {
					int wordId = trainCorpus.get(docId).get(j);
                                       // System.out.print(", "+id2WordVocabulary.get(wordId));
					int topic = new Integer(strTopics[j]);
                                        //System.out.print("'-topic is "+topic);
		...
		for (int dIndex = 0; dIndex < numDocuments; dIndex++) {
			...
			for (int wIndex = 0; wIndex < docSize; wIndex++) {
				...
				int word = corpus.get(dIndex).get(wIndex);
                                //int worde=corpuse.get(dIndex).get(wIndex);
	...
	public void writeParameters()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.paras"));
	...
	public void writeDictionary()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.vocabulary"));
	...
	public void writeIDbasedCorpus()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.IDcorpus"));
		for (int dIndex = 0; dIndex < numDocuments; dIndex++) {
			int docSize = corpus.get(dIndex).size();
			for (int wIndex = 0; wIndex < docSize; wIndex++) {
	...
	public void writeTopicAssignments()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.topicAssignments"));
		for (int dIndex = 0; dIndex < numDocuments; dIndex++) {
			int docSize = corpus.get(dIndex).size();
			for (int wIndex = 0; wIndex < docSize; wIndex++) {
	...
	public void writeTopTopicalWords()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.topWords"));
	...
	public void writeTopicWordPros()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.phi"));
		for (int i = 0; i < numTopics; i++) {
	...
	public void writeTopicWordCount()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.WTcount"));
		for (int i = 0; i < numTopics; i++) {
			for (int j = 0; j < vocabularySize; j++) {
	...
	public void writeDocTopicPros()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.theta"));
		...
		for (int i = 0; i < numDocuments; i++) {
			...
			writer.write("\n");
                        System.out.println("topic of "+i+"is "+dtopic);
                        dtopictheta[i]=dtopic;
		}
		writer.close();
	}
	...
	public void writeDocTopicCount()
		throws IOException
	{
		BufferedWriter writer = new BufferedWriter(new FileWriter("/home/cec/STTM/results/LDAinfE.DTcount"));
		for (int i = 0; i < numDocuments; i++) {
			for (int j = 0; j < numTopics; j++) {
		...
		throws Exception
	{
		LDA_Inf lda = new LDA_Inf(
			"/home/cec/STTM/results/tweetnewsLDA.paras", "/home/cec/STTM/src/dataset/newscorpus.txt", 100,10, "LDAinf",
			0);
		lda.inference();
	}
}
