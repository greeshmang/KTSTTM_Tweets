...
public class WNTM
{
    ...
    public void constructWordGraph()
    {
        for (int i = 0; i < numDocuments; i++) {
            ...
            int dd=corpus.get(i).size();
            System.out.println("Word Graph");
            for (int k = 0;  k<docSize-1; k++) 
            {
                for (int l = 0;  l<docSize-1; l++) 
                {
                System.out.print(wordNeighbor[k][l]+" ");
    ...
    public static void main(String args[])
            throws Exception
    {
        WNTM wntm = new WNTM("/home/cec/STTM/src/dataset/GoogleNews.txt", 152, 0.1,
                0.01, 1000, 10, 10, "gnewsWNTM"); 
